...
| Text answer | `qwen/qwen3-vl-8b-instruct` | OpenRouter / OpenAI-compatible API | Yes |
| Image-aware answer | `qwen/qwen3-vl-8b-instruct` (vision) | OpenRouter / OpenAI-compatible API | Yes |
