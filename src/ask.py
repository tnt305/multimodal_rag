...
def main() -> None:
    ...
    parser.add_argument("--model", default=os.getenv("QA_MODEL", "qwen3-vl-8b-instruct"))
    parser.add_argument("--vision", action="store_true")
    parser.add_argument("--vision-model", default=os.getenv("VISION_MODEL", "qwen3-vl-8b-instruct"))
