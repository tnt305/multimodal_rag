...
def main() -> None:
    ...
    check.add_argument("--model", default=os.getenv("QA_MODEL", "qwen/qwen3-vl-8b-instruct"))
    ask = sub.add_parser("ask", help="Text QA using an explicit context file")
    ask.add_argument("question")
    ask.add_argument("--context", type=Path, required=True)
    ask.add_argument("--model", default=os.getenv("QA_MODEL", "qwen/qwen3-vl-8b-instruct"))
    ...
    vision.add_argument("--model", default=os.getenv("VISION_MODEL", "qwen/qwen3-vl-8b-instruct"))
