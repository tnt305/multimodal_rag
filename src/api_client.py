...
def main() -> None:
    ...
    check.add_argument("--model", default=os.getenv("QA_MODEL", "openai/gpt-4o-mini"))
    ask = sub.add_parser("ask", help="Text QA using an explicit context file")
    ask.add_argument("question")
    ask.add_argument("--context", type=Path, required=True)
    ask.add_argument("--model", default=os.getenv("QA_MODEL", "openai/gpt-4o-mini"))
    ...
    vision.add_argument("--model", default=os.getenv("VISION_MODEL", "openai/gpt-4o-mini"))
